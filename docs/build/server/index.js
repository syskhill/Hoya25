import { g as get, L as LEGACY_PROPS, f as flush_sync, d as define_property, i as increment_write_version, D as DIRTY, s as set_signal_status, C as CLEAN, U as UNOWNED, a as DERIVED, b as schedule_effect, c as init_operations, e as get_first_child, h as get_next_sibling, j as hydration_failed, k as clear_text_content, l as array_from, m as component_root, n as active_reaction, u as untracking, o as is_runes, B as BLOCK_EFFECT, p as derived_sources, q as state_unsafe_mutation, r as active_effect, t as BRANCH_EFFECT, R as ROOT_EFFECT, v as untracked_writes, w as set_untracked_writes, M as MAYBE_DIRTY, x as safe_equals, y as set_active_reaction, z as set_active_effect, A as is_array, E as create_text, F as branch, G as push$1, H as pop$1, I as equals, J as component_context, K as base, N as has_data_suffix, O as strip_data_suffix, P as decode_pathname, Q as decode_params, S as BROWSER, T as normalize_path, V as disable_search, W as writable, X as override, Y as reset, Z as assets, _ as add_data_suffix, $ as make_trackable, a0 as readable, a1 as resolve } from './chunks/exports-B0-_ODdN.js';
import { H as HttpError, j as json, t as text, R as Redirect, S as SvelteKitError, p as public_env, s as safe_public_env, a as set_public_env, b as set_safe_public_env, A as ActionFailure, c as set_private_env } from './chunks/shared-server-Bjgho-38.js';
import { r as render, H as HYDRATION_START, a as HYDRATION_ERROR, b as HYDRATION_END, p as push, s as setContext, c as pop } from './chunks/index2-DWzDfzvQ.js';
...
async function get_hooks() {
  ...
  let handleError;
  let init;
  ({ handle, handleFetch, handleError, init } = await import('./chunks/hooks.server-DpDMY-Iw.js'));
  let reroute;
  let transport;
  ({ reroute, transport } = await import('./chunks/hooks-BrWW2IsS.js'));
  return {
    handle,
    handleFetch,
    handleError,
